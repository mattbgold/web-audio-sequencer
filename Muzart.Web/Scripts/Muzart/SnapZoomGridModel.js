...
(function ($, Muzart) {
    ...
    Muzart.SnapZoomGridModel = function (baseWidth, baseHeight, zoomLevel, snapMode) {
        ...
        self.zoomLevel = ko.observable(zoomLevel || 4); // increase zoomLevel to zoom in. 1 is no zoom
